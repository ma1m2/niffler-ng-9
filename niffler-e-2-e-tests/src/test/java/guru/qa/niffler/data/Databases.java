...
public class Databases {
  ...
  public static <T> T transaction(Function<Connection, T> function, String jdbcUrl, int isolationLvl) {
    ...
    try {
      ...
      connection.setTransactionIsolation(isolationLvl);//Connection.TRANSACTION_SERIALIZABLE = 8; 1,2,4
  ...
  public static void transaction(Consumer<Connection> consumer, String jdbcUrl){
    transaction(consumer, jdbcUrl, Connection.TRANSACTION_READ_COMMITTED);//=2
  }
