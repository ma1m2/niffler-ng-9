...
public class StatComponent extends BaseComponent<StatComponent> {
  ...
  @Step("Check that statistic bubbles contain texts {texts}")
  @Nonnull
  ...
  @Step("Check that first stat bubble contains color {expectedColors}")
  @Nonnull
  public StatComponent checkFirstBubble(Color expectedColor) {
